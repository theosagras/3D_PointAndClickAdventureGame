...
public class SettingsMenuScript: MonoBehaviour
{
    ...
    public void SetColorSaveBtnBlack()
    {
        saveBtn.GetComponent<Text>().color = Color.black; // Changes the colour of the text
    }
    public void inGameMenuPressed()
    {
     
        menuBtnAnim.SetTrigger("menuUp");
        StartCoroutine(PauseGame());
    }
    public void returnToGamePressed()
    {
    
        menuBtnAnim.SetTrigger("menuDown");
        Time.timeScale = 1;
    }
    ...
    public void SaveSettings()
    {
        ...
        saveBtn.GetComponent<Text>().color = Color.green; // Changes the colour of the text
    }
